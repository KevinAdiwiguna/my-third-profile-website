...
export const List = (props) => {
  return (
    <div className='flex justify-center items-center h-[70vh] flex-col'>
        <div className={`text-center text-lg px-5 pb-4 pt-10 rounded-lg hover:bg-background ${props.scroll ? "!opacity-0 pointer-events-none" : "opacity-100 pointer-events-auto"} duration-300`}>
