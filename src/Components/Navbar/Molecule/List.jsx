...
export const List = (props) => {
  return (
    <div className='flex justify-center items-center h-[70vh] flex-col'>
        <div className={`text-center text-lg px-5 pb-4 pt-10 rounded-lg hover:bg-background ${props.scroll ? "sm:opacity-0 pointer-events-none" : "sm:opacity-100 sm:pointer-events-auto"} ${props.open ? 'sm:!opacity-100' : ""}  ${props.open ? 'opacity-100 pointer-events-auto' : "opacity-0"} duration-300`}>
